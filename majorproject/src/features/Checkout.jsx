...
import { saveorder, sendmail } from './Admin/hiddenlinks'
...
const Checkout = () => {
    ...
    const shipingAddress=useSelector(selectShippingAddress)
    ...
    let CODorder=()=>{
        ...
        let orderconfig={userId,userEmail,shipingAddress,cartItems,totalAmount,payment_mode,payment_id,orderDate,orderTime,orderStatus}
  ...
  return (
    <div className='container mt-5 p-3 shadow'>
        <div className="row">
            ...
            <div className="col">
                <h1>Please Order</h1><br/>
                <button type="button" class="btn btn-primary mb-3" onClick={CODorder}>Cash on Delivery</button><br/>
                <Link type="button" class="btn btn-danger" to='/checkout-payment' >Stripe Payment</Link>
            </div>
        </div> 
