  ...
  return (
    <>
        <Card className='mt-4'>
            <Card.Header>
                <h1>Add Category 
                    <Link type="button" class="btn btn-primary float-end btn-lg" to='/admin/view/category'>View Categories</Link>
                </h1>
            </Card.Header>
            <Card.Body>
                <Form onSubmit={handleSubmit}>
                    ...
                    onClick={(e)=>setCategory({...category,isActive:!category.isActive})} checked={category.isActive}></input>
                    </div><br/>              
